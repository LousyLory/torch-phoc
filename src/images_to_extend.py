...
model_path = '/home/ray/torch-phoc/src/PHOCNet_0.pt'
#model_path = '/home/ray/torch-phoc/src/PHOCNet_0.pt'#'models/PHOCNet_Nov13.pt' # path of the phoc model to use
